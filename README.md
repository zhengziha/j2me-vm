...
*   **核心功能**:
    *   完整的类加载器 (`ClassLoader`)，支持 `.jar` 和 `.class` 文件。
...
*   [架构设计 (Architecture)](docs/ARCHITECTURE.md): 虚拟机的整体架构与设计理念。
*   [解释器重构 (Interpreter Refactoring)](docs/Refactoring%20Interpreter.cpp.md): 解释器核心的重构细节。
*   [实现计划 (Implementation Plans)](docs/): 各阶段的开发计划与进度。
